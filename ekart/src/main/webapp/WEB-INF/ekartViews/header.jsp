      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <c:if test="${pageContext.request.userPrincipal.name!=null}"><li><a href="">Hello ${pageContext.request.userPrincipal.name}</a></li></c:if>
         <c:if test="${pageContext.request.userPrincipal.name!=null }">
          ...
          <c:if test="${pageContext.request.userPrincipal.name==null}"><li><a href="${pageContext.request.contextPath}/addUsers"><span class="glyphicon glyphicon-register"></span> Sign UP</a></li></c:if>
...
<li><a href="${pageContext.request.contextPath}/admin/productForm">Admin Control</a></li>
</security:authorize>
